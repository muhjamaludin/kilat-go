...
module.exports = {
  getAllPrice: function (conditions = {}) {
    ...
    return new Promise(function (resolve, reject) {
      const sql = `SELECT buses.bus_name, buses.class_bus, buses.bus_seat, routes.departure, routes.destination, schedules.departure_time, schedules.arrive_time, prices.price
